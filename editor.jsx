...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        const buttons = [
            ...
            {
                label: () => previewRef.value ? '编辑' : '锁定', icon: () => previewRef.value ? 'icon-edit' : 'icon-reset', handler: () => {
            ...
            {
                label: '后端？', icon: 'icon-browse', handler: () => {
                    // editorRef.value = false;
                    // clearBlockFocus();
                }
            },
        ...
        return () => !editorRef.value ? <>
            ...
            <div>
                <ElButton type="primary"  round  onClick={() => editorRef.value = true}>继续编辑</ElButton>
